...
const SetColour = () => {
  ...
  return (
    <view>
      <Text
        id="text"
        style={{ fontSize: fontSize, backgroundColor: `rgb(${R}, ${G}, ${B})` }}
      >
        &nbsp;&nbsp;&nbsp;&nbsp;
      </Text>
      ...
      <Button
        title="Perbesar"
        onPress={() => perbesar((fontSize) => fontSize + 1)}
      />
...
const KomNilai = () => {
  ...
  return (
    <View>
      <Text>
        Skor anda {nilai} dengan predikat {nisbi(nilai)}
      </Text>
...
const Pet = (prop) => {
  ...
  return (
    <View>
      <Text>
        I am your pet! I am a {prop.type}. {voice(action)}
      </Text>
